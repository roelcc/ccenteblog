...
<div class="form-group">
	{{ Form::label('subtitulo 2', 'Sub Titulo') }}
	{{ Form::text('sub_title_1', null, ['class' => 'form-control', 'id' => 'sub_title_1']) }}
</div>
<div class="form-group">
	{{ Form::label('subtitulo 2', 'Sub Titulo') }}
	{{ Form::text('sub_title_2', null, ['class' => 'form-control', 'id' => 'sub_title_2']) }}
</div>
<div class="form-group">
...
{{--</div>--}}
<div class="form-group">
	{{ Form::label('question_0', 'question_0') }}
	{{ Form::textarea('question_0', null, ['class' => 'form-control', 'rows' => '2']) }}
</div>
<div class="form-group">
...
<div class="form-group">
	{{ Form::label('question_6', 'question_6') }}
	{{ Form::textarea('question_6', null, ['class' => 'form-control', 'rows' => '2']) }}
</div>
